...
extension CAFETITest22ViewController {
  ...
  func layoutCoffeeImageView() {
    self.view.add(self.coffeeImageView) {
      $0.image = UIImage(named: "frame135")
      $0.snp.makeConstraints {
  ...
  @objc func clickedButton(_ sender: UIButton) {
    ...
    if self.selectedIndex == 0 {
      self.coffeeImageView.image = UIImage(named: "frame121")
      self.pagingnum = 1
    }
    if self.selectedIndex == 1 {
      self.coffeeImageView.image = UIImage(named: "frame122")
      self.pagingnum = 1
    }
    if self.selectedIndex == 2 {
      self.coffeeImageView.image = UIImage(named: "frame123")
      self.pagingnum = 1
    }
  }
